namespace Igtampe.Controllers {
    ...
    public class ErrorResult {
        ...
        /// <summary>An "I'm Teacup" (418) Error Result</summary>
        /// <param name="Reason">Reason</param>
        /// <returns></returns>
        public static ErrorResult Teapot(string Reason = "") => new() { Code = TEACUP, Reason = Reason };
